...
//static import method of classes method.
...
public class DateTimeExample {
    public static void getLocalDateTimeDescription(){
        ...
        System.out.println(MonthDay.from(LocalDateTime.now().plus(2,ChronoUnit.DAYS)));
        //method plus for time changing in process
        System.out.println(DayOfWeek.from(LocalDateTime.now()));
        System.out.println(MonthDay.from(LocalDateTime.now().minus(Period.ofWeeks(5))));

        //method with gets TemporalAdjusters - abstract class, or TemporalAdjuster - interface common for all 3 variants.
        ...
        // statical import
        //it can be called without calling class.for suitable object.
        ...
        String str = LocalDateTime.now().with(lastDayOfMonth()).toString();
//      //
